...
/* Different Token type possibilities */
pub enum TokenType {
...
impl fmt::Display for ByteType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ByteType::INVALID => write!(f, "INVALID"),
            ByteType::WHITESPACE => write!(f, "WHITESPACE"),
            ByteType::PUNCTUATION => write!(f, "PUNCTUATION"),
...
pub fn get_byte_type(value: u8) -> &'static ByteType {
    // Should automatically return ByteType::INVALID if value > 127
